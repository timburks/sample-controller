...
func NewForConfig(c *rest.Config) (*ApicontrollerV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new ApicontrollerV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ApicontrollerV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &ApicontrollerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ApicontrollerV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ApicontrollerV1alpha1Client {
...
// New creates a new ApicontrollerV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ApicontrollerV1alpha1Client {
	return &ApicontrollerV1alpha1Client{c}
}
...
func (c *ApicontrollerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
